...
function App() {
  ...
  return (
    <div className={`app-container ${isAdminRoute ? 'admin-app' : ''}`}>
      ...
      <main className={!isAdminRoute ? "main-content" : ""}>
        <Routes>
          ...
          <Route path="/admin" element={<EmployeeLayout />}>
            ...
            <Route path="settings" element={<div style={{padding: '2rem'}}><h2>Cài đặt hệ thống (Đang phát triển)</h2></div>} />
          </Route>

          <Route path="*" element={<div className="empty-state"><h1>404</h1><p>Trang không tồn tại.</p></div>} />
        </Routes>
      </main>
