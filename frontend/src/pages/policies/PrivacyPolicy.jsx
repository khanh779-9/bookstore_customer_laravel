    ...
    <div className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            <div className="flex items-center gap-3">
              <span className="bg-primary text-white text-[10px] font-black px-3 py-1 rounded-none tracking-widest uppercase">GDPR Compliant</span>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <div className="bg-white p-4 rounded-none shadow-none border border-gray-100 flex items-center gap-3 group hover:border-primary transition-all">
                <div className="w-10 h-10 bg-blue-50 text-blue-500 rounded-none flex items-center justify-center text-xl group-hover:bg-primary group-hover:text-white transition-all"><FiLock /></div>
                <div>
              ...
              <div className="bg-white p-4 rounded-none shadow-none border border-gray-100 flex items-center gap-3 group hover:border-primary transition-all">
                <div className="w-10 h-10 bg-green-50 text-green-500 rounded-none flex items-center justify-center text-xl group-hover:bg-primary group-hover:text-white transition-all"><FiShield /></div>
                <div>
          ...
          <div className="lg:w-1/3 bg-white/60 backdrop-blur-md p-8 rounded-none border border-white shadow-none space-y-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-primary text-white rounded-none flex items-center justify-center text-xl shadow-none shadow-green-100"><FiLock /></div>
              <div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-blue-500 text-white rounded-none flex items-center justify-center text-xl shadow-none shadow-blue-100"><FiUserCheck /></div>
              <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-8">
          <section className="bg-white p-10 rounded-none border border-gray-100 shadow-none space-y-6">
            <div className="flex items-center justify-between">
              ...
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-none text-[10px] font-black text-primary tracking-widest uppercase">GDPR</span>
            </div>
          ...
          <section className="bg-white p-10 rounded-none border border-gray-100 shadow-none space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="bg-gray-50 p-6 rounded-none border border-transparent hover:border-blue-100 hover:bg-blue-50/30 transition-all flex items-start gap-4 group">
                  <div className="w-10 h-10 bg-white text-blue-500 rounded-none flex items-center justify-center shadow-none group-hover:scale-110 transition-transform">
                    {item.icon}
                  </div>
                  <div>
        ...
        <aside className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-primary text-white p-8 rounded-none shadow-none shadow-green-100 space-y-4">
            ...
            <button className="w-full py-3 bg-white text-primary font-black rounded-none shadow-none hover:scale-105 active:scale-95 transition-all text-sm uppercase tracking-tight">
              Hỏi về bảo mật
            </button>
          </div>
        </aside>
