    ...
    <div className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            <div className="flex items-center gap-3">
              <span className="bg-primary text-white text-[10px] font-black px-3 py-1 rounded-full tracking-widest uppercase">BookZone Logistics</span>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-3 group hover:border-primary transition-all">
                <div className="w-10 h-10 bg-green-50 text-green-500 rounded-xl flex items-center justify-center text-xl group-hover:bg-primary group-hover:text-white transition-all"><FiZap /></div>
                <div>
              ...
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-3 group hover:border-primary transition-all">
                <div className="w-10 h-10 bg-blue-50 text-blue-500 rounded-xl flex items-center justify-center text-xl group-hover:bg-primary group-hover:text-white transition-all"><FiGlobe /></div>
                <div>
          ...
          <div className="lg:w-1/3 bg-white/60 backdrop-blur-md p-8 rounded-[2.5rem] border border-white shadow-2xl space-y-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-green-500 text-white rounded-full flex items-center justify-center text-xl shadow-lg shadow-green-100"><FiTruck /></div>
              <div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-blue-500 text-white rounded-full flex items-center justify-center text-xl shadow-lg shadow-blue-100"><FiSearch /></div>
              <div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-purple-500 text-white rounded-full flex items-center justify-center text-xl shadow-lg shadow-purple-100"><FiShield /></div>
              <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-8">
          <section className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-8">
            <div className="flex items-center justify-between">
              ...
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-[10px] font-black text-primary tracking-widest uppercase">4 LỰA CHỌN</span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="bg-gray-50 p-6 rounded-2xl border border-transparent hover:border-green-100 hover:bg-green-50/30 transition-all flex items-start gap-4 group">
                  <div className="w-10 h-10 bg-white text-green-500 rounded-xl flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                    {item.icon}
                  </div>
                  <div>
        ...
        <aside className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-gray-900 text-white p-10 rounded-[2.5rem] shadow-xl space-y-6">
            ...
            <button className="w-full py-4 bg-primary text-white font-black rounded-2xl shadow-xl hover:scale-105 active:scale-95 transition-all">
              LIÊN HỆ HỖ TRỢ
            </button>
          </div>
        </aside>
