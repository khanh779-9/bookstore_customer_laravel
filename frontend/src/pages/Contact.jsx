  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-7xl">
      ...
      <div className="text-center mb-16 space-y-4">
        <h1 className="text-4xl md:text-6xl font-black text-gray-900 italic tracking-tight">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 group">
                ...
                <div>
                  ...
                  <a
                    href="tel:0239482958"
                    className="text-gray-500 hover:text-primary transition-colors italic font-bold"
                  >
                    (+84) 0239 482 958
                  </a>
                </div>
          ...
          <div className="bg-white rounded-[2.5rem] p-10 md:p-12 shadow-sm border border-gray-100">
            ...
            {submitted ? (
              <div className="py-20 text-center space-y-6">
                ...
                <p className="text-gray-500 italic">
                  Cảm ơn bạn đã quan tâm. Chúng tôi sẽ phản hồi trong vòng 24h
                  làm việc.
                </p>
                <button
