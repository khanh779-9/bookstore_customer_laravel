...
ALTER TABLE `thongbao` ADD PRIMARY KEY (`thongbao_id`), ADD KEY `fk_khid` (`khachhang_id`);
...
(1, 'Sách giáo khoa Toán 10 – Bộ Cánh Diều (Tập 1)', 1, 'toan10_canhdieu_tap_1.jpg', '...', 129, 1, 47, 45000.000, 1),
(2, 'Ngữ văn 11 - Tập 1', 1, 'Ngu-Van-11-Tap-1-600x853.jpg', '...', 112, 1, 33, 50000.000, 1),
(3, 'Tiếng Anh 12 - Sách học sinh', 1, 'ta12-global.png', '...', 75, 1, 23, 52000.000, 2),
(4, 'Tiếng Anh 12 - Sách bài tập', 1, 'sach_ta_12_bt.jpg', '...', 195, 1, 85, 98000.000, 2),
(5, 'Đắc Nhân Tâm - Dale Carnegie', 1, 'dac-nhan-tam-1.jpg', '...', 298, 1, 120, 85000.000, 1),
(6, 'Harry Potter và Hòn đá Phù Thủy', 1, 'Sach-Noi-Harry-Potter-Tap-1-J-K-Rowling-audio-book-sachnoi.cc-4.jpg', '...', 88, 1, 61, 135000.000, 2),
(7, 'Vở hồng hà 96 trang', 2, 'vo_hong_ha_96t.jpg', '...', 300, 2, 40, 82000.000, 3),
(21, 'Thước nhôm 30cm', 2, 'thuoc_nhom_30cm.jpg', '...', 29, 2, 44, 15000.000, 3),
(24, 'Từ điển Y học – Sức khoẻ – Bệnh lý (Anh – Việt)', 1, 'td04.jpg', '...', 1200, 1, 0, 35000.000, 12),
(26, 'Từ điển Mẫu câu tiếng Nhật', 1, 'td01.jpg', '...', 600, 1, 0, 54000.000, 11),
(27, 'Kế toán Doanh nghiệp ACCESS', 1, 'th12.jpg', '...', 700, 1, 0, 70000.000, 16),
(28, 'Hộp tập giấy A4 – 400 tờ', 2, 'tap-giay-a4-400-to.jpg', '...', 500, 1, 0, 100000.000, 14),
(29, 'Từ điển Kinh doanh – Tiếp thị Hiện đại', 1, 'td02.gif', '...', 600, 1, 23, 23000.000, 1),
(30, 'Đại từ điển tiếng Việt', 1, 'td03.jpg', '...', 600, 1, 23, 25000.000, 3),
(31, 'Từ điển mới ...', 1, 'td05.jpg', '...', 300, 1, 12, 50000.000, 2),
(32, 'Từ điển địa danh hành chính Nam Bộ', 1, 'td06.jpg', '...', 500, 1, 50, 300000.000, 2),
(33, '100 thủ thuật ứng với 100 bài tập thực hành', 1, 'th01.gif', '...', 400, 1, 0, 60000.000, 2),
(34, 'Lập trình Web bằng PHP 5.3 và cơ sở dữ liệu MySQL 5.1 - Tập 2', 1, 'th02.jpg', '...', 60, 1, 0, 80000.000, 2),
(35, 'Lập trình Web bằng PHP 5.3 và cơ sở dữ liệu MySQL 5.1 - Tập 1', 1, 'th03.jpg', '...', 100, 1, 0, 80000.000, 1),
(36, 'Tin học thực hành cơ bản', 1, 'th04.jpg', '...', 100, 1, 0, 35000.000, 1),
(37, 'Làm việc với máy tính qua desktop', 1, 'th05.jpg', '...', 20, 1, 0, 35000.000, 1),
(38, 'Windows Server 2008', 1, 'th06.jpg', '...', 23, 1, 0, 65000.000, 2),
(39, 'Lập trình C nâng cao', 1, 'th06.jpg', '...', 100, 1, 0, 80000.000, 2),
(40, 'Giáo trình học nhanh SQL Server 2008', 1, 'th08.jpg', '...', 100, 1, 0, 90000.000, 2),
(41, '160 Vấn Đề Cần Nên Biết Khi Sử Dụng Đồ Họa Máy Vi Tính', 1, 'th09.jpg', '...', 321, 1, 0, 100000.000, 2),
(42, 'Giáo trình học nhanh SQL Server 2008', 1, 'th10.jpg', '...', 500, 1, 0, 70000.000, 2),
(43, 'Microsoft Word 2007 thủ thuật', 1, 'th11.jpg', '...', 100, 1, 0, 75000.000, 1),
(44, 'Kế toán doanh nghiệp Access', 1, 'th12.jpg', '', 50, 1, 0, 80000.000, 11),
(45, 'C++ nâng cao', 1, 'th13.gif', '...', 200, 1, 0, 83000.000, 11),
(46, 'Thủ thuật thiết kế Web nhanh', 1, 'th14.jpg', '...', 200, 1, 0, 100000.000, 12),
(47, 'Tạo Website Hấp Dẫn Với HTML, XHTML Và CSS', 1, 'th15.jpg', '...', 200, 1, 0, 90000.000, 1),
(48, 'Tuyển Tập Thủ Thuật Javascript', 1, 'th16.jpg', '...', 100, 1, 0, 72000.000, 16),
(49, 'Thiết Kế Web Với CSS', 1, 'th17.jpg', '...', 100, 1, 0, 90000.000, 12),
(50, 'Thiết Kế Web Với JavaScript Và Dom', 1, 'th18.jpg', '...', 299, 1, 0, 92000.000, 1),
...
ALTER TABLE `thongbao` ADD CONSTRAINT `fk_khid` FOREIGN KEY (`khachhang_id`) REFERENCES `khachhang` (`khachhang_id`) ON DELETE CASCADE ON UPDATE CASCADE;
