...
--
-- Dumping data for table `diachi_giaohang`
--
...
(5, 'Giảm giá mùa tựu trường', '2025-08-01', '2025-09-30'),
(6, 'Khuyến mãi Giáng Sinh', '2025-12-01', '2025-12-25'),
(7, 'Khuyến mãi Tết Nguyên Đán', '2026-01-15', '2026-02-10'),
(8, 'Giảm giá mùa hè', '2026-06-01', '2026-07-31'),
...
('vat_ly', 'Vật lý'),
('hoahoc', 'Hóa học'),
('giaokhoa', 'Sách giáo khoa'),
('kythuat', 'Kỹ thuật'),
('kinhte', 'Kinh tế'),
('ngoaingu', 'Ngoại ngữ'),
('phapluat', 'Pháp luật'),
('tudien', 'Từ điển'),
('loaimoi', 'Sách mới/Hot'),
('tinhoc', 'Tin học - CNTT'),
('toanhoc', 'Toán học'),
('thethao_dulich', 'Thể thao & Du lịch'),
('vanhoc', 'Văn học'),
('vanhoa_xahoi', 'Văn hóa - Xã hội');
...
(3, '$2y$10$14TzzgK9p6mkF9uEpp3Ok.Gv1uMZCW1cxXcnKvJFdqVWhp3ruqoD.', 'Trần', 'Quốc', 'Khánh', 'Nam', '2004-09-02', 'STU 180 Cao Lỗ, Quận 8', '0124456', 'du122o@maily.org', '2025-12-10', 'dang_lam', 'admin', '4444', '2025-12-10 04:17:10', '2025-12-13 09:40:23'),
...
INSERT INTO `sach` (`sach_id`, `sanpham_id`, `tenSach`, `nhaxuatban_id`, `namXB`, `tacgia_id`, `loaisach_code`) VALUES
(1, 1, 'Sách Toán 10 - Bộ Cánh Diều', 1, '2024', 1, 'giaokhoa'),
(2, 2, 'Sách Ngữ văn 11 - Tập 1', 1, '2024', 1, 'giaokhoa'),
(3, 3, 'Sách Tiếng Anh 12 - Sách học sinh', 1, '2024', 2, 'ngoaingu'),
(4, 4, 'Sách Tiếng Anh 12 - Sách bài tập', 3, '2023', 2, 'vanhoc'),
(5, 5, 'Sách Đắc Nhân Tâm', 5, '2022', 5, 'kinhte'),
(6, 6, 'Sách Harry Potter và Hòn đá Phù triết gia - Tập 1', 3, '2021', 6, 'vanhoc'),
(8, 23, 'fffff', 22, '2005', 20, 'vanhoc'),
(9, 24, 'Từ điển y học sức khoẻ bệnh lý (Anh - Việt)', 11, '1998', 16, 'tudien'),
(11, 26, 'Từ điển mẫu câu tiếng Nhật', 23, '1999', 27, 'ngoaingu'),
(12, 27, 'Kế toán doanh nghiệp ACCESS', 22, '2003', 29, 'kinhte'),
(13, 29, 'Từ Điển Kinh Doanh Và Tiếp Thị Hiện Đại', 11, '2003', 5, 'kinhte'),
(14, 30, 'Đại Từ Điển Tiếng Việt (Bản mới 2010)', 7, '2010', 18, 'tudien'),
(15, 31, 'Từ Điển Anh Việt - 75000 Từ', 17, '2010', 14, 'tudien'),
(16, 32, 'Từ điển địa danh hành chính Nam Bộ', 15, '2010', 33, 'tudien'),
(17, 33, 'Sách 100 thủ thuật với Excel 2010', 6, '2010', NULL, 'tinhoc'),
(18, 34, 'Lập trình web bằng PHP 5.3 và cơ sở dữ liệu', 1, '2010', 28, 'tinhoc'),
(19, 35, 'Lập trình web bằng PHP 5.3 và cơ sở dữ liệu MySQL 5.1 (Tập1)', 18, '2010', NULL, 'tinhoc'),
(20, 36, 'Làm Quen Với Internet', 18, '2010', 28, 'tinhoc'),
(21, 37, 'Từng Bước Làm Quen Với Máy Tính', NULL, '2008', 28, 'tinhoc'),
(22, 38, 'Quản Trị Windows Server 2008 - Tập 2', 3, '2007', 28, 'tinhoc'),
(23, 39, 'Kỹ Thuật Lập Trình C - Cơ Sở Và Nâng Cao', NULL, '2007', NULL, 'tinhoc'),
(24, 40, 'Giáo Trình Học Nhanh SQL Server 2008 - Tập 2', 3, '2009', 28, 'tinhoc'),
(25, 41, '160 Vấn Đề Cần Nên Biết Khi Sử Dụng Đồ Họa Máy Vi Tính', 3, '2012', 28, 'tinhoc'),
(26, 42, 'Giáo Trình Học Nhanh SQL Server 2008 - Tập 1', 3, '2010', NULL, 'tinhoc'),
(27, 43, 'Microsoft Word 2007 - Căn Bản Và Thủ Thuật', 1, '2010', 28, 'tinhoc'),
(28, 44, 'Kế Toán Doanh Nghiệp Với ACCESS', 3, '2007', 28, 'loaimoi'),
(29, 45, 'Giáo Trình C++ & Lập Trình Hướng Đối Tượng', 6, '2010', 28, 'tinhoc'),
(30, 46, 'Các Thủ Thuật Trong HTML Và Thiết Kế Web', 18, '2010', 28, 'tinhoc'),
(31, 47, 'Tạo Website Hấp Dẫn Với HTML, XHTML Và CSS', 18, '2010', 17, 'tinhoc'),
(32, 48, 'Tuyển Tập Thủ Thuật Javascript - Tập 1', 18, '2010', 28, 'tinhoc'),
(33, 49, 'Thiết Kế Web Với CSS', 18, '2010', 8, 'tinhoc'),
(34, 50, 'Thiết Kế Web Với JavaScript Và Dom', 6, '2010', 28, 'tinhoc');
...
(2, 1, 7, '2025-12-01 10:30:31'),
(3, 1, 1, '2025-12-01 10:35:29'),
(5, 1, 21, '2025-12-07 19:41:12'),
(6, 1, 4, '2025-12-10 15:01:44'),
(7, 5, 24, '2025-12-11 23:31:44'),
(8, 4, 3, '2025-12-13 17:51:44'),
(9, 4, 2, '2025-12-13 17:51:47'),
(10, 4, 42, '2025-12-21 16:20:55'),
(11, 4, 21, '2025-12-21 16:20:57'),
(12, 4, 39, '2025-12-21 16:21:01');
...
CREATE TABLE `thongbao` (
  ...
  `loai` enum('khach_hang','don_hang','he_thong','') NOT NULL,
  `trang_thai` enum('da_doc','chua_doc','luu_tru','') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'chua_doc'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(7, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-08 22:49:03', 'khach_hang', 'chua_doc'),
(8, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-10 07:20:21', 'khach_hang', 'chua_doc'),
(9, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-10 11:14:54', 'khach_hang', 'chua_doc'),
(10, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-10 13:18:31', 'khach_hang', 'chua_doc'),
(11, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-10 14:52:22', 'khach_hang', 'da_doc'),
...
(13, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 15:23:39', 'khach_hang', 'da_doc'),
(14, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 15:23:37', 'khach_hang', 'da_doc'),
(15, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 15:23:34', 'khach_hang', 'da_doc'),
(16, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 15:23:33', 'khach_hang', 'da_doc'),
(17, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 15:23:30', 'khach_hang', 'da_doc'),
(18, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 15:23:28', 'khach_hang', 'da_doc'),
(19, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 15:23:25', 'khach_hang', 'da_doc'),
...
(22, 1, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 15:23:20', 'khach_hang', 'da_doc'),
(23, 5, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-11 21:42:31', 'khach_hang', 'chua_doc'),
(24, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-12 22:20:30', 'khach_hang', 'chua_doc'),
(25, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-13 11:24:54', 'khach_hang', 'chua_doc'),
(26, 4, 'Đơn hàng', 'Đơn hàng #17 của bạn đã được tạo thành công.', '2025-12-13 11:25:37', 'khach_hang', 'chua_doc'),
(27, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-13 17:46:27', 'khach_hang', 'chua_doc'),
(28, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-13 17:50:00', 'khach_hang', 'chua_doc'),
(29, 4, 'Đơn hàng', 'Đơn hàng #18 của bạn đã được tạo thành công.', '2025-12-13 17:52:27', 'khach_hang', 'chua_doc'),
(30, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-14 10:38:15', 'khach_hang', 'chua_doc'),
(31, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-14 11:12:58', 'khach_hang', 'chua_doc'),
...
(33, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-19 23:58:55', 'khach_hang', 'chua_doc'),
(34, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-21 15:39:21', 'khach_hang', 'chua_doc'),
(35, 4, 'Đăng nhập tài khoản', 'Phát hiện lần đăng nhập mới nhất từ \nThiết bị: Desktop\nTrình duyệt: Chrome\nHệ điều hành: Windows 10', '2025-12-21 16:09:00', 'khach_hang', 'chua_doc');
...
CREATE TABLE `vanphongpham` (
  `vpp_id` int NOT NULL,
  `sanpham_id` int DEFAULT NULL,
  `tenVPP` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `vanphongpham` (`vpp_id`, `sanpham_id`, `tenVPP`) VALUES
(1, 7, 'Vở Hồng Hà 96 trang (10 quyển/lốc)'),
(5, 21, 'Thước kẻ bằng nhôm 30cm'),
(7, 28, 'Hộp tập giấy A4 - 400 tờ'),
(8, 51, 'adassad');
...
ALTER TABLE `sach`
  ...
  ADD KEY `sanpham_id` (`sanpham_id`),
  ADD KEY `nhaxuatban_id` (`nhaxuatban_id`),
  ADD KEY `tacgia_id` (`tacgia_id`),
  ADD KEY `loaisach_code` (`loaisach_code`);
...
--
ALTER TABLE `chitietgiohang`
  MODIFY `ctgh_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `chitiethoadon`
--
ALTER TABLE `chitiethoadon`
  MODIFY `cthd_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `chitietkhuyenmai`
--
ALTER TABLE `chitietkhuyenmai`
  MODIFY `ctkm_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `danhgia`
--
ALTER TABLE `danhgia`
  MODIFY `danhgia_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `danhmucsanpham`
--
ALTER TABLE `danhmucsanpham`
  MODIFY `danhmucSP_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `diachi_giaohang`
--
ALTER TABLE `diachi_giaohang`
  MODIFY `dcgh_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `donvitinh`
--
ALTER TABLE `donvitinh`
  MODIFY `donvitinh_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `giohang`
--
ALTER TABLE `giohang`
  MODIFY `giohang_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `hoadon`
--
ALTER TABLE `hoadon`
  MODIFY `hoadon_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `khachhang`
--
ALTER TABLE `khachhang`
  MODIFY `khachhang_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `khuyenmai`
--
ALTER TABLE `khuyenmai`
  MODIFY `khuyenmai_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `nhacungcap`
--
ALTER TABLE `nhacungcap`
  MODIFY `nhacungcap_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `nhanvien`
--
ALTER TABLE `nhanvien`
  MODIFY `nhanvien_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `nhaxuatban`
--
ALTER TABLE `nhaxuatban`
  MODIFY `nhaxuatban_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `sach`
--
ALTER TABLE `sach`
  MODIFY `sach_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `sanpham`
--
ALTER TABLE `sanpham`
  MODIFY `sanpham_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `sanphamyeuthich`
--
ALTER TABLE `sanphamyeuthich`
  MODIFY `spyt_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tacgia`
--
ALTER TABLE `tacgia`
  MODIFY `tacgia_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `thongbao`
--
ALTER TABLE `thongbao`
  MODIFY `thongbao_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `vanphongpham`
--
ALTER TABLE `vanphongpham`
  MODIFY `vpp_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `chitietgiohang`
  ADD CONSTRAINT `chitietgiohang_ibfk_1` FOREIGN KEY (`giohang_id`) REFERENCES `giohang` (`giohang_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chitietgiohang_ibfk_2` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `chitiethoadon`
--
ALTER TABLE `chitiethoadon`
  ADD CONSTRAINT `chitiethoadon_ibfk_1` FOREIGN KEY (`hoadon_id`) REFERENCES `hoadon` (`hoadon_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chitiethoadon_ibfk_2` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `chitietkhuyenmai`
--
ALTER TABLE `chitietkhuyenmai`
  ADD CONSTRAINT `chitietkhuyenmai_ibfk_1` FOREIGN KEY (`khuyenmai_id`) REFERENCES `khuyenmai` (`khuyenmai_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chitietkhuyenmai_ibfk_2` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `danhgia`
--
ALTER TABLE `danhgia`
  ADD CONSTRAINT `danhgia_ibfk_1` FOREIGN KEY (`khachhang_id`) REFERENCES `khachhang` (`khachhang_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `danhgia_ibfk_2` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `diachi_giaohang`
--
ALTER TABLE `diachi_giaohang`
  ADD CONSTRAINT `diachi_giaohang_ibfk_1` FOREIGN KEY (`khachhang_id`) REFERENCES `khachhang` (`khachhang_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `giohang`
--
ALTER TABLE `giohang`
  ADD CONSTRAINT `giohang_ibfk_1` FOREIGN KEY (`khachhang_id`) REFERENCES `khachhang` (`khachhang_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `sach`
  ADD CONSTRAINT `sach_ibfk_1` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sach_ibfk_2` FOREIGN KEY (`nhaxuatban_id`) REFERENCES `nhaxuatban` (`nhaxuatban_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `sach_ibfk_3` FOREIGN KEY (`tacgia_id`) REFERENCES `tacgia` (`tacgia_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `sach_ibfk_4` FOREIGN KEY (`loaisach_code`) REFERENCES `loaisach` (`loaisach_code`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `sanpham`
--
ALTER TABLE `sanpham`
  ADD CONSTRAINT `sanpham_ibfk_1` FOREIGN KEY (`donvitinh_id`) REFERENCES `donvitinh` (`donvitinh_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `sanpham_ibfk_2` FOREIGN KEY (`danhmucSP_id`) REFERENCES `danhmucsanpham` (`danhmucSP_id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `sanphamyeuthich`
--
ALTER TABLE `sanphamyeuthich`
  ADD CONSTRAINT `sanphamyeuthich_ibfk_1` FOREIGN KEY (`khachhang_id`) REFERENCES `khachhang` (`khachhang_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sanphamyeuthich_ibfk_2` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `vanphongpham`
  ADD CONSTRAINT `vanphongpham_ibfk_1` FOREIGN KEY (`sanpham_id`) REFERENCES `sanpham` (`sanpham_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
